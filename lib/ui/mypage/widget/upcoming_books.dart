...
class UpcomingBooks extends ConsumerWidget {
  final String userId;
  final bool isMySns;

  const UpcomingBooks({super.key, required this.userId, required this.isMySns});
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          final book = state.upcomingBooks[index];
